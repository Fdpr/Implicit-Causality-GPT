...
df_1 = pd.read_csv("../data/Judge_1_not_corrected_ChatGPT_Bloom.csv", sep=";")
...
"""
df_2 = pd.read_csv("../data/Judge_2_not_corrected_ChatGPT_Bloom.csv", sep=";")
...
df_3 = pd.read_csv("../data/Judge_3_not_corrected_ChatGPT.csv", sep=";")
