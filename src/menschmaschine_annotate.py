...
df_2 = do_annotation(df_2, prefix="Human_")
df_2["cont"] = df_2["ChatGPT"]
df_2 = do_annotation(df_2, prefix="ChatGPT_")
df_2["cont"] = df_2["Bloom"]
df_2 = do_annotation(df_2, prefix="Bloom_")
...
df_3 = do_annotation(df_3, prefix="Human_")
df_3["cont"] = df_3["ChatGPT"]
df_3 = do_annotation(df_3, prefix="ChatGPT_")
