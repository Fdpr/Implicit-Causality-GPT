...
for model_name in models:
    ...
    print(model("Andra überraschte Malte, weil", remove_invalid_values=True, num_return_sequences = 1, no_repeat_ngram = 2, early_stopping = True, force_words_ids=force_words_ids, do_sample = False, num_beams = 10, max_new_tokens = 20))
    del model
    del tokenizer