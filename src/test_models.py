...
for model_name in models:
    ...
    print(model("Ich bin ein Sprachmodell, also", remove_invalid_values=True, early_stopping = True, force_words_ids=force_words_ids, do_sample = False, diversity_penalty = .6, num_beam_groups = 5, num_beams = 10, max_new_tokens = 20))
    del model
    del tokenizer